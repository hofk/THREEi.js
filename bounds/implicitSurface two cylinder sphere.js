...
const b = [ Infinity, -Infinity, 2.6, -2.6, Infinity, -Infinity ]; // bounds xMax, xMin, yMax, yMin, zMax, zMin
...
const b = [ Infinity, -Infinity, 3, -3, Infinity, -Infinity ]; // bounds xMax, xMin, yMax, yMin, zMax, zMin
*/